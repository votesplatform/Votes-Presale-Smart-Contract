...
contract VotesPlatformTokenPreSale is Ownable {
    ...
    string public name = "Votes Platform Token PreSale";
    ...
    function VotesPlatformTokenPreSale(
        ...
        tokensPerEther = _totalTokens / hardCap;

        purchaseLimit = _purchaseLimitUSD * 1 ether / _priceETH * tokensPerEther;
    ...
    function refund() external onlyAfter(endTime) {
        ...
        require(balance > 0);
        uint refund = balance / tokensPerEther;
